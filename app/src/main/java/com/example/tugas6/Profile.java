...
public class Profile extends AppCompatActivity {
    ...
    private void editData() {
        if (getIntent().getBundleExtra("userdata")!= null){Bundle
        ...
        binding.btnSubmit.setOnClickListener(new
                                                     View.OnClickListener() {
                                                         ...
                                                         public void onClick(View v) {
                                                             ...
                                                             cv.put("star",
                                                                     binding.edtstar.getText().toString());
                                                             cv.put("avatar",
                                                             ...
                                                             Long rec = sqLiteDatabase.insert("home", null,
                                                                     cv);
                                                             if (rec != null) {
                                                                 Toast.makeText(Profile.this, "Data Inserted",
                                                   ...
                                                   View.OnClickListener() {
                                                       ...
                                                       public void onClick(View v) {
                                                           ...
                                                           cv.put("avatar",
                                                                   imageViewToBy(binding.edtimage));
                                                           sqLiteDatabase = dBmain.getWritableDatabase();
                                                           long recedit = sqLiteDatabase.update(TABLENAME,
                                                                   cv, "id=" + id, null);
                                                           if (recedit != -1) {
